...
module View
  class Welcome < Snabberb::Component
    ...
    def render_notification
      message = <<~MESSAGE
        <p>18USA, <a href='https://github.com/tobymao/18xx/wiki/18MT:-Big-Sky-Barons'>18MT: Big Sky Barons</a>, 1852: Missouri (18MO), and 21Moon are now in alpha. 18NewEngland and 18NewEngland 2 are now in beta.</p>
