...
module View
  class Welcome < Snabberb::Component
    ...
    def render_notification
      message = <<~MESSAGE
        <p>Prototype games <a href='https://github.com/tobymao/18xx/wiki/18MT:-Big-Sky-Barons'>18MT: Big Sky Barons</a>, 1852: Missouri (18MO) and 21Moon are now in alpha.</p>
