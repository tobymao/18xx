...
module Engine
  module Part
    class Partition < Base
      attr_reader :a, :a_sign, :b, :b_sign, :len, :type, :restrict, :blockers, :inner, :outer
      ...
      def initialize(a, b, type, restrict, len: nil)
        ...
        #   toward vertex b. len:0.5 on opposite vertices (e.g. a:3,b:0) reaches hex centre.
        # Without len, a/b are sorted (minmax) for consistent routing restriction ranges.
        a, b = [a, b].minmax unless len
        @a = a.to_i
        @a_sign = SIGN[a[1]]
        @b = b[0].to_i
        @b_sign = SIGN[b[1]]
