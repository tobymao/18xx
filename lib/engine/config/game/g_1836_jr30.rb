        ...
        JSON = <<-'DATA'
{
   ...
   "hexes":{
      ...
      "blue":{
         "offboard=revenue:yellow_20|brown_30,groups:port,route:never;path=a:4,b:_0;path=a:5,b:_0":[
            "E3",
            "G1"
         ]
      },
      "green":{
         "offboard=revenue:yellow_20|brown_30,groups:port,route:never;path=a:3,b:_0;path=a:4,b:_0":[
            "J2"
         ]
      }
   },
