  ...
  "companies": [
    {
      ...
      "debt": 80,
      "revenue": 0,
      "desc": "Starts with $60 in treasury, a 2 train, and a token in Detroit (O3). Splits revenue evenly with owner. $80 debt must be paid by purchaser."
    },
    {
      "name": "Big 4",
      "value": 40,
      "debt": 60,
      "revenue": 0,
      "desc": "Starts with $40 in treasury, a 2 train, and a token in Indianapolis (I7). Splits revenue evenly with owner. $60 debt must be paid by purchaser."
    },
    {
