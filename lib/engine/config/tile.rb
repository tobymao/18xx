  ...
  module Config
    module Tile
      ...
      YELLOW = {
        ...
        '437' => 'town=revenue:30;path=a:0,b:_0;path=a:_0,b:2;label=P',
      ...
      GREEN = {
        ...
        '80' => 'path=a:0,b:junction;path=a:1,b:junction;path=a:2,b:junction',
        '81' => 'path=a:0,b:junction;path=a:2,b:junction;path=a:4,b:junction',
        '82' => 'path=a:0,b:junction;path=a:1,b:junction;path=a:3,b:junction',
        '83' => 'path=a:0,b:junction;path=a:5,b:junction;path=a:3,b:junction',
        ...
        '750' => 'town=revenue:0;path=a:0,b:junction;path=a:1,b:junction;path=a:2,b:junction;label=£',
        '751' => 'town=revenue:0;path=a:0,b:junction;path=a:5,b:junction;path=a:3,b:junction;label=£',
        '752' => 'town=revenue:0;path=a:0,b:junction;path=a:1,b:junction;path=a:3,b:junction;label=£',
        '753' => 'town=revenue:0;path=a:0,b:junction;path=a:2,b:junction;path=a:4,b:junction;label=£',
      ...
      BROWN = {
        ...
        '106' => 'path=a:0,b:junction,track:dual;path=a:2,b:junction,track:dual;path=a:4,b:junction,track:dual;path=a:3,b:junction,track:dual',
        '107' => 'path=a:0,b:junction,track:dual;path=a:1,b:junction,track:dual;path=a:3,b:junction,track:dual;path=a:4,b:junction,track:dual',
        ...
        '544' => 'path=a:0,b:junction;path=a:1,b:junction;path=a:3,b:junction;path=a:4,b:junction',
        '545' => 'path=a:0,b:junction;path=a:1,b:junction;path=a:2,b:junction;path=a:3,b:junction',
        '546' => 'path=a:0,b:junction;path=a:2,b:junction;path=a:3,b:junction;path=a:4,b:junction',
      ...
      GRAY = {
        ...
        '60' => 'path=a:0,b:junction;path=a:1,b:junction;path=a:2,b:junction;path=a:3,b:junction;path=a:4,b:junction;path=a:5,b:junction',
        ...
        '112' => 'path=a:0,b:junction,track:dual;path=a:1,b:junction,track:dual;path=a:2,b:junction,track:dual;path=a:3,b:junction,track:dual;path=a:4,b:junction,track:dual',
