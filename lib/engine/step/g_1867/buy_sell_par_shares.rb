      ...
      class BuySellParShares < BuySellParShares
        ...
        def can_bid?(entity)
          ...
          @game.corporations.any? do |c|
            @game.corporation_parrable?(c, entity) && c.type == :minor && can_buy?(entity, c.shares.first&.to_bundle)
          end
        end
        ...
        def can_ipo_any?(entity)
          ...
          @game.corporations.any? do |c|
            @game.corporation_parrable?(c, entity) && c.type == :major && can_buy?(entity, c.shares.first&.to_bundle)
          end
        end
