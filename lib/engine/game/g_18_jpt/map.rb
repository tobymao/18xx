    ...
    module G18JPT
      module Map
        ...
        HEXES = {
          ...
          yellow: {
            ['B84'] => 'city=revenue:20;upgrade=cost:120,terrain:mountain;path=a:3,b:_0;path=a:4,b:_0;upgrade=cost:80;label=T',
            ['B88'] => 'city=revenue:20;path=a:2,b:_0;path=a:3,b:_0;upgrade=cost:80;label=T',
            ['E83'] => 'city=revenue:20;path=a:2,b:_0;path=a:5,b:_0;upgrade=cost:80;label=T',
            ['E87'] => 'city=revenue:20;path=a:1,b:_0;path=a:4,b:_0;upgrade=cost:80;label=T',
