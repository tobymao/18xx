      ...
      module Map
        TILES = {
          ...
          'X9' => {
            'count' => 1,
            'color' => 'brown',
            'code' => 'city=revenue:70,loc:0.5;city=revenue:70,slots:2;'\
                      'path=a:0,b:_0;path=a:1,b:_0;path=a:2,b:_1;path=a:3,b:_1;label=P',
          },
          'X10' => {
            'count' => 1,
        ...
        HEXES = {
          white: {
            ...
            %w[B1 H11] => 'upgrade=cost:40,terrain:water',
            %w[B7 C2 E4 F7 G8 I4] => 'upgrade=cost:60,terrain:water',
            ...
            ['F11'] => 'upgrade=cost:40,terrain:water;border=edge:4,type:mountain',
