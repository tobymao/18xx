      ...
      module Map
        TILES = {
          ...
          'X1' => {
            'count' => 1,
            'color' => 'yellow',
            'code' => 'city=revenue:30,loc:0.5,reservation:PLM;city=revenue:30;upgrade=cost:50,terrain:water;'\
          ...
          'X8' => {
            'count' => 1,
            'color' => 'green',
            'code' => 'city=revenue:40,slots:2;upgrade=cost:50,terrain:water;path=a:0,b:_0;path=a:1,b:_0;path=a:3,b:_0;'\
        ...
        HEXES = {
          white: {
            %w[C4 C8 C10 D5 E8 E18 F3 F5 F17 G2 H5 H7 I6 I8 I12] => '',
            %w[B1 B7 C2 E4 F7 G8 H11 I4] => 'upgrade=cost:50,terrain:water',
            %w[B3 B9 D3 D9 D15 D17 E2 E6 E10 E16 H9 H17] => 'city=revenue:0',
            %w[G10] => 'city=revenue:0;upgrade=cost:50,terrain:water',
            ...
            ['C12'] => 'upgrade=cost:50,terrain:water;border=edge:3,type:mountain;border=edge:4,type:mountain;'\
            ...
            ['H13'] => 'upgrade=cost:50,terrain:water;border=edge:3,type:mountain;border=edge:4,type:mountain',
