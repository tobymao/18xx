    ...
    module G1822PNW
      module Entities
        COMPANIES = [
          ...
          {
            name: 'REGIONAL: A. Calgary Regional Railway',
            sym: 'MA',
            value: 100,
            revenue: 10,
            desc: 'Ownership certificate in the Calgary Regional Railway. Starting location is A22 (Calgary).',
            abilities: [],
            color: '#808080',
            text_color: 'black',
          },
          ...
          {
            name: 'REGIONAL: C. Vancouver Regional Railway',
            sym: 'MC',
            value: 100,
            revenue: 10,
