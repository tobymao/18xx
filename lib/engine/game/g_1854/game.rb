  ...
  module Game
    module G1854
      class Game < Game::Base
        ...
        ASSIGNMENT_TOKENS = {
          'B1' => '/icons/1854/B1.svg',
          'B2' => '/icons/1854/B2.svg',
          'B3' => '/icons/1854/B3.svg',
          'B4' => '/icons/1854/B4.svg',
          'B5' => '/icons/1854/B5.svg',
          'T1' => '/icons/1854/T1.svg',
          'T2' => '/icons/1854/T2.svg',
          'T3' => '/icons/1854/T3.svg',
          'T4' => '/icons/1854/T4.svg',
          'T5' => '/icons/1854/T5.svg',
        }.freeze
        ...
        def init_stock_market
          G1854::StockMarket.new(game_market, self.class::CERT_LIMIT_TYPES,
        ...
        def stock_round
          Engine::Round::Stock.new(self, [
            G1854::Step::MountainRailwayTrack,
            G1854::Step::BuySellParShares,
          ])
        end

        def operating_round(round_num)
          G1854::Round::Operating.new(self, [
            Engine::Step::Bankrupt,
            Engine::Step::DiscardTrain,
            Engine::Step::Exchange,
            G1854::Step::SpecialChoose,
            G1854::Step::SpecialTrack,
            G1854::Step::Destination,
            G1854::Step::BuyCompany,
            Engine::Step::HomeToken,
            Engine::Step::Track,
            G1854::Step::DestinationCheck,
            Engine::Step::Token,
            G1854::Step::DestinationCheck,
            G1854::Step::Route,
            G1854::Step::Dividend,
            G1854::Step::BuyTrain,
            [G1854::Step::BuyCompany, { blocks: true }],
          ], round_num: round_num)
        end

        def new_sbb_formation_round
          @log << '-- SBB Formation Round --'
          G1854::Round::SBBFormation.new(self, [
            Engine::Step::DiscardTrain,
            G1854::Step::RemoveSBBTokens,
          ])
        end
