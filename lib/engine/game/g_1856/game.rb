    ...
    module G1856
      class Game < Game::Base
        ...
        def game_phases
          ...
          excluded = eight_train_variant? ? 'D' : '8'
        ...
        STATUS_TEXT = {
          ...
          'facing_2' => [
            ...
            'An unstarted corporation needs 20% sold from the IPO to start for the first time (30% if the last 2-train
            has been purchased)',
          ],
          'facing_3' => [
            '30% to start (40% to start once the last 3-train is purchased)',
            'An unstarted corporation needs 30% sold from the IPO to start for the first time (40% if the last 3-train
            has been purchased)',
          ],
          'facing_4' => [
