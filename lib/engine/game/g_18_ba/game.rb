  ...
  module Game
    module G18BA
      class Game < Game::Base
        include_meta(G18BA::Meta)
        include Entities
        include Map

        CORPORATION_CLASS = G18BA::Corporation
        DEPOT_CLASS = G18BA::Depot
        ...
        def new_auction_round
          Engine::Round::Auction.new(self, [
            G18BA::Step::SelectionAuction,
          ])
        end

        def stock_round
          Engine::Round::Stock.new(self, [
            G18BA::Step::HomeToken,
            G18BA::Step::DiscardTrain,
            G18BA::Step::BuySellParShares,
          ])
        end

        def operating_round(round_num)
          G18BA::Round::Operating.new(self, [
            G18BA::Step::Bankrupt,
            G18BA::Step::HomeToken,
            G18BA::Step::DiscardTrain,
            G18BA::Step::SpecialTrack,
            G18BA::Step::Track,
            G18BA::Step::Token,
            Engine::Step::Route,
            G18BA::Step::Dividend,
        ...
        def exchange_round(round_num)
          G18BA::Round::Exchange.new(self, [
            G18BA::Step::DiscardTrain,
            G18BA::Step::CoalExchange,
            G18BA::Step::MinorExchange,
          ], round_num: round_num)
        end
        ...
        def blocking_token
          @blocker ||= Corporation.new(sym: 'B', name: '', logo: '18BA/blocking', tokens: [])
          Token.new(@blocker)
        end
