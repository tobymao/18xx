      ...
      module Map
        ...
        HEXES = {
          white: {
            ...
            %w[K8] =>
                    'icon=image:1858/MZ;' \
                    'stub=edge:1;stub=edge:4;' \
                    'border=type:province,edge:1;' \
                    'border=type:province,edge:2',
            %w[F17] =>
                    'icon=image:1858/CS;' \
                    'stub=edge:1;stub=edge:5;' \
                    'border=type:province,edge:2;' \
          ...
          yellow: {
            ...
            %w[H11] =>
                    ...
                    'icon=image:1858/MV;icon=image:1858/MA;icon=image:1858/CMP;' \
                    'border=type:province,edge:2;' \
                    'border=type:province,edge:3;' \
                    'label=M',
            %w[H13] =>
