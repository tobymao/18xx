...
module Engine
  module Game
    module G1832
      module Market
        STANDARD_TOP_LINE = %w[64y 68 72 76 82 90 100p 110 120 140 160 180 200 225 250 275 300 325 350 375 400].freeze
        FINISH_ON_400_TOP_LINE = %w[64y 68 72 76 82 90 100p 110 120 140 160 180 200 225 250 275 300 325 350 375 400e].freeze
