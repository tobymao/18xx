...
module Engine
  describe Corporation do
    ...
    let(:game) { Engine::Game::G1889::Game.new(%w[a b c]) }
    ...
    describe '#<=>' do
      it 'should sort' do
        ...
        game.par_corporation(corporation_1, share_price_100)
        game.par_corporation(corporation_2, share_price_100)
        game.par_corporation(corporation_3, share_price_100_r)
        game.par_corporation(corporation_4, share_price_110)
