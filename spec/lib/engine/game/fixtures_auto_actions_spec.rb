...
module Engine
  AUTO_FIXTURES = [
    ...
    '18VA/auto_auction_bid.json', # Auto-bid then auto-pass as high bidder in 18VA's cycling auction
    '18VA/auto_auction_pass.json', # "Auto-pass unless outbid" holding a winning bid through 18VA's auction
  ].freeze
