    ...
    TEST_CASES = [
      ...
      ['1846', 'hs_sudambau_1600037415', 60, 'buy_train_bankrupt',
       ['B&amp;O has $0',
        ...
        'Declare Bankruptcy']],
      ['18AL', 4714, nil, 'endgame', '18AL: Operating Round 7.2 (of 3) - Game Over - Company hit max stock value'],
      ['18GA', 9222, nil, 'endgame', '18GA: Operating Round 9.1 (of 3) - Game Over - Bank Broken'],
      ['18TN', 7818, nil, 'endgame', '18TN: Operating Round 8.2 (of 3) - Game Over - Bank Broken'],
      ['18MS', 14_375, nil, 'endgame', '18MS: Operating Round 10 (of 10) - Game end after OR 10 - Game Over'],
      ['18MEX', 13_315, 278, 'merge',
       ['Merge',
        'Decline',
